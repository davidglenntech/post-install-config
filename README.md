...
_Next, we'll move on to creating a Team._ <br>
...
- Click on the "Access" tab:
  ...
  - Assign this user the Role we created (this example uses **Supreme Admin**).
...
- Click on the "Teams" tab:
  -  Assign this user to the Team we created (this example uses **Level II Support**).
...
- Create the following plans:
  - **SEV-A**
    - Grace Period: **1 hour** (_Amount, in hours, before tickets with this SLA will become overdue if not closed in the allotted time._)
